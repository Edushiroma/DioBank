...
namespace Dio.Bank
{
    class Program
    {
        ...
        {
            /*Conta minhaConta = new Conta(TipoConta.PessoaFisica, 0, 0, "Eduardo Shiroma");
        ...
        private static void ListarContas() //retorna a quantidade de contas registradas na operação
        {
